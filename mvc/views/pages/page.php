...
<div class="container" style="margin-left: 500px">
  <ul class="pagination">
    <?php
      ...
      {
        echo "<li class='page-item'><a style = 'color: #733619' class='page-link '".'href="./'.$PageName.'?page=1">Đầu</a></li>';
        echo "<li class='page-item'><a style = 'color: #733619' class='page-link '".'href="./'.$PageName.'?page='.($page-1).'">Trước</a></li>';
      }
    ?>
 <?php                                                                           
    ...
    <?php
      if($page>=$pages)
      {
        echo "<li class='page-item'><span style = 'color: #733619' class='page-link'>Sau</span></li>";
        echo "<li class='page-item'><span style = 'color: #733619' class='page-link'>Cuối</span></li>";
      }
      else
      {
